...
const functionParent = document.getElementById("functionParent")
const closeFunctionB = document.getElementById("closeFunctionButton")
const functionInput = document.getElementById("functionInput") as HTMLInputElement
const addGameButtonParent = document.getElementById("addGameButtonParent")
const loadGamesButton = document.getElementById("loadGamesButton")

functionParent.style.display = "none"

const gameContainer = (iconPath: string, link: string, name: string, version: string) => {
    const img = document.createElement("img")
    const gameName = document.createElement("a")
    const gameVersion = document.createElement("p")
    const gameDiv = document.createElement("DIV")
    const closeB = document.createElement("button")
    const functionB = document.createElement("button")
...
addButton.onclick = () => {
    ...
    const inputLink = document.getElementById("inputLink") as HTMLInputElement
